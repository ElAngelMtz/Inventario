        ...
        <Container>
            <div className="content-wrapper-context">
                ...
                <div className="content-text">
                    El Rincón del Machape te mantiene siempre informado
                </div>
                <ContentCards>
            ...
            <div className="contentsvg">
                <svg className="opacity-0 group-hover:opacity-100 transform-gpu transition-all will-change-auto duration-600 ease-in-out" viewBox="0 0 492 253" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <filter id="filter0_f_934_1718" x="-120.728" y="0.703659" width="734.383" height="794.376" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
